...
def train_target(args):
    ...
    for iter_num in pbar:
        ...
        pbar.set_postfix({'cls loss': classifier_loss.item()})
...
if __name__ == "__main__":
    ...
    for i in range(len(names)):
        ...
        args.output_dir = osp.join(args.output, args.da, args.dset, args.attack_type, names[args.s][0].upper()+names[args.t][0].upper())
